...
const LeavePage = () => {
  ...
  useEffect(() => {
    ...
    console.log('LeavePage mounted. Stored caretakerId:', storedCaretakerId);
    if (storedId) {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('Submitting leave request with caretakerId:', caretakerId);

    if (!caretakerId) {
      alert('Caretaker ID is missing. Please log in again.');
      return;
    }
        ...
        <div className="col-md-8 col-lg-6">
          <div className="card shadow">
            <div className="card-header" style={{ backgroundColor: '#EADDCA', color: '#6f4e37' }}>
              <h3 className="text-center">Student Leave Request Form</h3>
            </div>
            <div className="card-body">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  <label htmlFor="leaveStart" className="form-label">Leave Start Date and Time</label>
                  <input
                    type="datetime-local"
                    className="form-control"
                    id="leaveStart"
                ...
                <div className="mb-3">
                  <label htmlFor="leaveEnd" className="form-label">Leave End Date and Time</label>
                  <input
                    type="datetime-local"
                    className="form-control"
                    id="leaveEnd"
